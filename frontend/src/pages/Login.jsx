...
const API_URL = 'http://localhost:5000/api/v1/auth'; // Update if your API URL is different
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (loginSuccess) {
      ...
      throw new Error('Login failed - no error thrown but login not successful');
    }
  } catch (err) {
