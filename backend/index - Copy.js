...
const paymentRoutes = require('./src/routes/paymentRoutes');  // Add this line with other route imports
...
app.use('/api/deliverables', deliverableRoutes); // Add this line with other route mounts
